...
/*****************  Bit definition for RCC_AHBPRSTR register  *****************/

#define RCC_ETH_MACRST ((uint32_t)0x00004000)
...
#define RCC_ETH_MACEN ((uint32_t)0x00004000)
#define RCC_ETH_MAC_TXEN ((uint32_t)0x00008000)
#define RCC_ETH_MAC_RXEN ((uint32_t)0x00010000)
